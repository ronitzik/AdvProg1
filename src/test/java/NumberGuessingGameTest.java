...
public class NumberGuessingGameTest {
    ...
    public void testBadGuessInput() {
        ...
        assertEquals("You must guess a number!", up.getMessages(player).get(0));
    }
    ...
    public void testExactGuess() {
        ...
        assertEquals("Move response incorrect", "Yay! " + player.getName() + " has guessed the number!",
                up.getMessages().get(0));
